...
class TT100K_Template_DataGenerator(tensorflow.keras.utils.Sequence):
    'Generates data for Keras'
    def __init__(
        self,n_way,k_shot,n_query,data_path='datasets/TT100K',
        batch=500,data_type = 'all',augmentation=False,
        target_size=(64,64)):
        'Initialization'
        self.n_way = n_way
        self.k_shot = k_shot
    ...
    def __data_generation(self):
        ...
        for _ in range(self.n_query):
            ...
            X[i] = img_to_array(load_img(os.path.join(c_path,qfile),target_size=(64,64)))
            labels[lidx] = cls_idx
            i += 1
            lidx += 1
