...
class GTSRB_Template_DataGenerator(tensorflow.keras.utils.Sequence):
    ...
    def __init__(
        self,n_way,k_shot,n_query,data_path='datasets/belga',
        batch=64,augmentation=False,
        target_size=(64,64)):
        'Initialization'
        self.n_way = n_way
        self.k_shot = k_shot
    ...
    def __data_generation(self):
        ...
        for _ in range(self.n_query):
            ...
            c_main = os.path.join(self.query_path,str(c))
            c_path = os.path.join(c_main,self.sub_folder[np.random.randint(2)])
